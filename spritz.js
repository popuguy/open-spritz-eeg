// spritz.js
// A Lightly Modified JavaScript Speed Reader
// popuguy
// https://github.com/popuguy/open-spritz-eeg and https://github.com/Miserlou/OpenSpritz
...
function spritzify(input){
    ...
    function startSpritz() {
        ...
        spritz_timers.push(setInterval(function() {
            ...
            currentWord++;
            console.log("pushed value from startSpritz");
            if (init_ms_per_word != ms_per_word) {
                clearSpritz();
                init_ms_per_word = ms_per_word;
                startSpritz();
                console.log("got an ms_per_word modification");
            }
